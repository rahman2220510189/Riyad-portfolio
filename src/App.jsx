...
import { 
  ...
  ChevronDown, GraduationCap, BookOpen, Award, Server, Briefcase, Send 
} from 'lucide-react';
import img from '../src/assets/riyad.jpg'
import img1 from '../src/assets/riyad1.jpg'


// API Configuration (Preserved from Code-2)
...
function App() {
  ...
  const [formStatus, setFormStatus] = useState(''); // For contact form status

  // Data Preserved from Code-2 (and enhanced with Code-1 structure)
  const skills = {
  ...
  return (
    <div className={`min-h-screen transition-colors duration-300 ${themeClasses}`}>
      ...
      <nav className={`fixed w-full z-50 transition-all duration-300 ${isDarkMode ? 'bg-gray-900/95' : 'bg-white/95'} backdrop-blur-sm shadow-xl`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex space-x-8 items-center">
              ...
              {/* Admin Button (Preserved from Code-2) */}
              <button 
            ...
            <div className="flex items-center space-x-4">
              {/* Dark Mode Toggle (Code-1 feature) */}
              <button
        ...
        {/* Mobile Navigation (Code-1 feature) */}
        {isMenuOpen && (
      ...
      {/* Admin Login Modal (Preserved from Code-2) */}
      ...
      {/* Hero Section (Enhanced with Code-1 Styling/Animations) */}
      <section id='home' className="min-h-screen flex items-center justify-center pt-20 px-4">
        <div className="max-w-7xl mx-auto text-center">
          <div className="animate-fade-in">
            {/* Image Placeholder (Preserved from Code-2) */}
    ...
    <div className="w-60 h-60 mx-auto rounded-full bg-gradient-to-br from-purple-500 to-pink-500 p-1 shadow-2xl">
        <div 
            ...
            {/* Buttons (Enhanced with Code-1 Styling) */}
            <div className="flex flex-wrap justify-center gap-4 mb-8">
              ...
              <a
                ...
                download
                className="px-8 py-3 bg-gradient-to-r from-green-500 to-emerald-500 rounded-full font-semibold hover:shadow-lg transform hover:-translate-y-1 transition-all duration-300 flex items-center gap-2"
              >
                <Download size={20} />
                Download CV
              </a>
            ...
            {/* Social Links (Enhanced with Code-1 Styling) */}
      ...
      {/* About Section (Enhanced with Code-1 Styling/Layout) */}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1 space-y-6">
              ...
              {/* Stats Grid (Added from Code-1 for professional look) */}
      ...
      {/* Education & Certifications Section (Preserved from Code-2) */}
      ...
      {/* Skills Section (Enhanced with Code-1 Layout) */}
      <section id="skills" className={`py-20 px-4 ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}>
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            {/* Backend (Merged with Database from Code-2 structure) */}
            <div className={`p-6 rounded-xl ${isDarkMode ? 'bg-gray-900' : 'bg-gray-100'} shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2`}>
            ...
            {/* Database (Added as separate visual card - from Code-1) */}
            <div className={`p-6 rounded-xl ${isDarkMode ? 'bg-gray-900' : 'bg-gray-100'} shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2`}>
      ...
      {/* Projects Section (Enhanced with Code-1 Styling/Layout, Preserved Code-2 Logic) */}
            ...
            {projects.map(project => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  {/* Admin Controls (Preserved from Code-2) */}
                  {isAdmin && (
      ...
      {/* Admin Panel (Preserved from Code-2) */}
      {isAdmin && (
      ...
      {/* Contact Section (Enhanced with Code-1 Styling/Form Status) */}
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className={`p-8 rounded-xl shadow-xl ${contactFormBg}`}>
            <div className="grid md:grid-cols-2 gap-8">
              {/* Contact Info (Preserved from Code-2) */}
              <div className="space-y-6">
              ...
              {/* Contact Form (Enhanced with Code-1 Styling/Feedback) */}
      ...
      {/* Footer (Enhanced with Code-1 Styling) */}
      <footer className={`py-8 px-4 ${isDarkMode ? 'bg-gray-900' : 'bg-gray-200'} text-center border-t ${isDarkMode ? 'border-purple-500/20' : 'border-gray-300'}`}>
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex justify-center gap-6 mt-4">
            ...
            <a href="mailto:riyad@example.com" className="hover:text-blue-500 transition-colors">
              <Mail size={24} />
            </a>
          </div>
        </div>
      ...
      {/* Global Styles for Animations (Code-1 feature) */}
      <style jsx>{`
        @keyframes gradient {
